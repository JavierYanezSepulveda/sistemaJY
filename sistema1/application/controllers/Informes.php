...
// Establecemos el contenido para imprimir
       ...
       //
        ...
        $html.= "<h4>Cantidad de ventas realizadas: ".count($resultados)."&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Desde&nbsp;" . date("d-m-Y ", strtotime($query1))."&nbsp;&nbsp;&nbsp;Hasta&nbsp;". date("d-m-Y ", strtotime($query2))."</h4>";
        $html.= "<table width='100%'>";
        $html.= "<tr><th>Numero compra</th><th>Factura</th><th>Subtotal</th><th>Total</th></tr>";
          $enseñanza1=0;
          $enseñanza=0;
        foreach ($resultados as $fila) {
            ...
            $html.= "<tr><td class='Numero boleta'>".$id."</td><td class='Detalle'>".$localidad."</td><td class='Detalle'>".$item."</td><td class='Valor Neto'>".$total."</td></tr>";
       }
        $html.= "</table>";
