...
<?php if(is_array($resultados)){?>
          ...
          <div class="col-md-4 col-md-offset-4">
            <form id="query1" method="POST" action=" <?=base_url();?>index.php/Informes/genera">
...
<div class="col">
  ...
  <?php foreach($resultados as $item):?>
    ...
    <?php foreach($ucc as $item2):?>
      ...
      <?php foreach($ucc as $item1):?>
      <?php if ($item['ID_UCC']===$item1['ID_UCC'] && $item1['TIPO_MATERIAL']==='0') {?>
          <td></td>
         <td><?php echo $item['TOTAL'];?></td>
     <?php } elseif ($item['ID_UCC']===$item1['ID_UCC'] && $item1['TIPO_MATERIAL']==='1') {?>
            <td ><?php echo $item['TOTAL']?></td>
            <td ></td>
...
<div class="col">  <?php $sumando=0;?>
            ...
            <?php foreach($resultados as $item):?>
              <?php foreach($ucc as $item1):?>
   <?php  if($item['ID_UCC']===$item1['ID_UCC'] && $item1['TIPO_MATERIAL']==='1') {?>
