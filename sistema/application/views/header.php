...
<link rel="stylesheet" type="text/css" href="<?php echo base_url();?>assets/css/jquery.dataTables.css">
  ...
  <body>
	<!-- <nav class="navbar navbar-expand-lg navbar-blue bg-white fixed-top"> -->
      <!-- <div class="container"> -->
       <!--  <a class="navbar" href="http://localhost/CIBOO">
          <img src="http://portal.ucm.cl//content/uploads/2016/10/logo.png" width="150" height="30" alt="">
        </a> -->
        <a href="#" class="navbar-left"><img src="http://portal.ucm.cl//content/uploads/2016/10/logo.pngg"></a>
 ...
 <!--      </div> -->
    ...
    <script src="<?php echo base_url();?>/assets/js/jquery-3.3.1.min.js" integrity="sha384-q8i/X+965DzO0rT7abK41JStQIAqVgRVzpbzo5smXKp4YfRvH+8abtTE1Pi6jizo" crossorigin="anonymous"></script>
    <script src="<?php echo base_url();?>/assets/js/popper.min.js" integrity="sha384-ZMP7rVo3mIykV+2+9J3UJ46jBk0WLaUAdn689aCwoqbBJiSnjAK/l8WvCWPIPm49" crossorigin="anonymous"></script>
 ...
 <script src="<?php echo base_url();?>/assets/js/jquery.js"></script>      
      <script src="<?=$base_url?>/ajax/ajax.js"></script>
